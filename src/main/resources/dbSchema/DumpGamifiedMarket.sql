...
INSERT INTO `answer` VALUES (2,9,1,'fef'),(2,9,2,'fef'),(2,9,3,'fef'),(2,9,4,'eff'),(2,9,5,'fe'),(2,9,6,'fe'),(2,9,8,'ciao'),(2,9,9,'ciao');
...
INSERT INTO `questionnaire` VALUES (2,1),(2,2),(2,3),(2,4),(2,5),(2,6),(2,8),(2,9);
...
INSERT INTO `user` VALUES (1,'user1','user1@mail.com','user1pass',_binary '',0,_binary '',_binary ''),(9,'user4','user4@mail.com','user4pass',_binary '',14,_binary '\0',_binary '');
...
CREATE TABLE `userlog` (
  ...
  KEY `userlog_product_id_product_fk` (`id_product`),
  CONSTRAINT `userlog_product_id_product_fk` FOREIGN KEY (`id_product`) REFERENCES `product` (`id_product`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userlog_user_id_user_fk` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON UPDATE CASCADE
...
--
-- Dumping events for database 'gamified_market'
--
...
BEGIN
    ...
    IF swear_num > 0
        THEN
            UPDATE user
            set user.authorized = 0
            where user.id_user = in_user;
...
-- Dump completed on 2021-02-04 16:09:37
